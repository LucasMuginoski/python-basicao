...
python mod.py (executa o modulo python)
python -u (unbuffered) => não salva nada no buffer (local da memoria)
python -m mod (lib mod como script) => executa uma lib do python como script
